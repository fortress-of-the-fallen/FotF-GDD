...
\noindent
Bảng dưới đây liệt kê các thuật ngữ và viết tắt thường được sử dụng trong báo cáo, đặc biệt liên quan tới phát triển game online, kiến trúc client--server và cơ sở dữ liệu. Các thuật ngữ này sẽ được dùng xuyên suốt các chương sau.
...
Chế độ người chơi chiến đấu trực tiếp với người chơi khác. Yêu cầu đồng bộ trạng thái nhanh, cơ chế xử lý độ trễ và biện pháp giảm gian lận phù hợp. \\ \hline
