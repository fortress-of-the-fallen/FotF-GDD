...
\hline
Hiện thực hệ thống server & Thiết kế/hiện thực backend theo mô-đun; tổ chức REST API cho các luồng cốt lõi; xác thực, phân quyền, xử lý lỗi; chuẩn hoá payload; quản lý session runtime và luồng nghiệp vụ chính; chuẩn bị thiết kế mở rộng WebSocket. & Trần Minh Khang & Hà Thái Toàn \\
\hline
Đồng bộ client--server & Thống nhất contract dữ liệu giữa UI và API (endpoint, request/response), rà soát mismatch, điều chỉnh luồng để đảm bảo trải nghiệm mượt và dữ liệu nhất quán; định nghĩa trước message envelope cho hướng realtime mở rộng. & Cả hai & Cả hai \\
\hline
\end{tabularx}
