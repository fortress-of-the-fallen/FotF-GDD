...
\hline
Lên ý tưởng đề tài & Thống nhất định hướng gameplay, scope hệ thống, các phân hệ chính (auth, player state, inventory/equipment, skills, quest, battle, castle, shop). & Toàn + Khang & Cả hai \\
\hline
...
\hline
Hiện thực hệ thống server & Thiết kế/hiện thực backend theo mô-đun; tổ chức REST API cho các luồng cốt lõi; xác thực, xử lý lỗi; chuẩn hoá payload; quản lý session runtime và luồng nghiệp vụ chính. & Trần Minh Khang & Hà Thái Toàn \\
\hline
Đồng bộ client--server & Thống nhất contract dữ liệu giữa UI và API (endpoint, request/response), rà soát mismatch, điều chỉnh luồng để đảm bảo trải nghiệm mượt và dữ liệu nhất quán. & Cả hai & Cả hai \\
\hline
\end{tabularx}
