...
\begin{itemize}
    ...
    \item \texttt{cooldown\_end} được xem là runtime; ở baseline hiện tại có thể không lưu bền vững (hoặc lưu tạm theo policy), tránh ghi DB liên tục.
    \item \texttt{STRUCT\_\allowbreak HOTBAR\_\allowbreak SLOT} gắn layout phím/\allowbreak slot với skill (hoặc item). Nếu \texttt{type=Item}, có thể mở rộng tham chiếu inventory theo policy (không bắt buộc ở baseline hiện tại).
\end{itemize}
