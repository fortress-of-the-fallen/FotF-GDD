...
Chương này trình bày các công nghệ và nền tảng phần mềm \textbf{đang sử dụng} trong đồ án để xây dựng trò chơi casual strategy trực tuyến. Nội dung tập trung vào vai trò của từng công nghệ trong kiến trúc tổng thể, các ưu điểm/\allowbreak hạn chế và lý do phù hợp với bối cảnh hệ thống game client--server hiện tại\cite{gregory-engine,moriarty-networked}.
...
\end{itemize}
Nguyên tắc này giúp giảm rủi ro gian lận và đảm bảo tính nhất quán dữ liệu giữa các phiên chơi.
...
Redis được sử dụng trước hết cho hiệu năng (cache); các vai trò phối hợp giữa nhiều tiến trình được mở theo nhu cầu triển khai\cite{redis-in-action}:
\begin{itemize}
