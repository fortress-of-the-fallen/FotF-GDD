...
\begin{itemize}
    ...
    \item \textbf{Hỗ trợ đa giao thức}: REST là kênh chính cho các luồng đã vận hành; WebSocket gateway là hướng mở rộng cho đồng bộ realtime sâu\cite{nest-docs}.
