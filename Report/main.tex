...
\definecolor{placeholderbg}{RGB}{250,250,250}
\definecolor{placeholderframe}{RGB}{150,150,150}
...
% ================== CHỐNG TRÀN DÒNG ==================
% Giảm Overfull \hbox trên tài liệu nhiều endpoint/code-like text
...
% Dùng cho các vị trí cần chụp màn hình thật sau này.
\newcommand{\ScreenshotPlaceholder}[3][5.5cm]{%
\begin{figure}[H]
    \centering
    \fcolorbox{placeholderframe}{placeholderbg}{%
        \begin{minipage}[c][#1][c]{0.88\textwidth}
            \centering
            \textbf{PLACEHOLDER HÌNH}\\[0.25cm]
            #2\\[0.2cm]
            {\small File gợi ý: \texttt{#3}}\\[0.15cm]
            {\small Chụp màn hình thật rồi thay placeholder này bằng \texttt{\string\includegraphics}.}
        \end{minipage}
    }
    \caption{#2}
    \label{fig:#3}
...
% ===================== PHỤ LỤC =====================
\clearpage
% \input{Content/appendices} % Removed per request: no appendix section in final report
